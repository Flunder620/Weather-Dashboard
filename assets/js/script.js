...
function displayCity(data) {
    ...
    cityConditionsEl.setAttribute('src',`https://openweathermap.org/img/wn/${data.list[0].weather[0].icon}.png`)
}
...
function displayFiveDay(data){
    ...
    for(var i = 0;  i < data.list.length; i=i+8){
        ...
        <img class="forecast-con" src="https://openweathermap.org/img/wn/${data.list[i].weather[0].icon}.png">
        <p class="forecast-temp">test</p>
